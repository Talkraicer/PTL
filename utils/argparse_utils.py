...
def get_args():
    ...
    parser.add_argument("-d", "--demand", type=str, default="DemandExtreme", help='Demand to run, None=all demands')
    parser.add_argument("-av", "--av_rate", type=float, default=None, help='AV rate to run, None=all av rates')
    parser.add_argument("--net_file" , type=str, default="network_extreme", help='Network file name (has to be in the SUMOconfig folder)')
