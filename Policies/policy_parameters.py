        ...
        "OneVariableControl":
            {
                ...
                "params": [
                              {"av_rate": av_rate, "variable": "ptl_speed", "param_range": param_range, "decision_rate": 60,
                               "inverse": True}
                              for param_range in
                          ...
                          [
                              {"av_rate": av_rate, "variable": "speed", "param_range": param_range, "decision_rate": 60, "inverse": True} for
                              param_range in
                          ...
                          [
                              {"av_rate": av_rate, "variable": "num_vehs", "decision_rate": 60, "param_range": param_range}
                              for param_range in
                          ...
                          [
                              {"av_rate": av_rate, "variable": "num_vehs_ptl", "decision_rate": 60, "param_range": param_range}
                              for param_range in
